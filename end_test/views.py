...
def index(request):
    ...
    template = loader.get_template('end_test/login.html')
    context = {}
...
def check_test(request):
    if request.method =='POST':
        ...
        context = {
            ...
            'number_correct_answers':correct_answers,
        }

        #delte session to in order to prevent the user to retry the test_date
